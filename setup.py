...
def get_version() -> str:
    with open("progan/version.py", "r") as foo:
...
setup(
    ...
    version=get_version(),
    # small description
    description="Implementation of the progressive gan paper",
    # long description
    long_description=long_description,
    # content type of long description
    long_description_content_type="text/markdown",
    # source code url for this package
    url="https://github.com/borhanMorphy/progressive-gan",
    ...
    keywords=["GAN", "progressive growing of gans", "image generation", "progan"],
    zip_safe=False,
